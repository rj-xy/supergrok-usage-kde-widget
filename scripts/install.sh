...
exec $(printf '%q' "$ROOT/scripts/supergrok-usage-kde-widget") "\$@"
EOF
    chmod 0755 "$BIN_DEST"
    ...
    ln -sfn "$ROOT/scripts/supergrok-usage-kde-widget" "$BIN_DEST"
    echo "› linked $BIN_DEST → $ROOT/scripts/supergrok-usage-kde-widget"
